...
# 2853 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\include\\pic_as_chip_select.inc" 3
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\include\\proc\\pic16f877a.inc" 1 3
# 47 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\include\\proc\\pic16f877a.inc" 3
INDF equ 0000h
...
EECON2 equ 018Dh
# 1879 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\include\\proc\\pic16f877a.inc" 3
...
# 2853 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\include\\pic_as_chip_select.inc" 2 3
...
INT_VECT:
    BTFSC INTCON,1 ;check if ((INTCON) and 07Fh), 1 is clear (check if true)
...
setup:
    ...
    ; 7 -> ((INTCON) and 07Fh), 7 (Global Interrupt Enable Pin)
    ; 4 -> ((INTCON) and 07Fh), 4 (((PORTB) and 07Fh), 0 External Interrupt Enable Pin)
    MOVLW (1<<7) | (1<<4)
    IORWF INTCON
